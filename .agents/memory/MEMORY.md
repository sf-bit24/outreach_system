...
- [Hunter+Dropcontact cascade](hunter-dropcontact-cascade.md) — fallback after website crawl; hunterClient.ts + dropcontactClient.ts; emailSource column tracks which step found the email.
